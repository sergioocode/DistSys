...
docker exec -it consul consul services register -name=OrdersApiWrite -address=localhost -port=60220
docker exec -it consul consul services register -name=OrdersApiRead -address=localhost -port=60221
