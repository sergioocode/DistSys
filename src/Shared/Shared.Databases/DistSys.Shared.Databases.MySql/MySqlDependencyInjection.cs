...
namespace DistSys.Shared.Databases.MySql;

public static class MySqlDependencyInjection
{
    public static IServiceCollection AddMySqlDbContext<T>(
        this IServiceCollection serviceCollection,
        Func<IServiceProvider, Task<string>> connectionString
    )
        where T : DbContext
    {
        return serviceCollection.AddDbContext<T>(
    ...
    public static IServiceCollection AddMysqlHealthCheck(
        this IServiceCollection serviceCollection,
        Func<IServiceProvider, Task<string>> connectionString
    )
    {
